...
class gsp_ala_hub_layoutsgeneric_gsp extends GroovyPage {
...
createTagBody(2, {->
printHtmlPart(0)
invokeTag('set','g',15,['var':("fluidLayout"),'value':(grailsApplication.config.skin.fluidLayout?.toBoolean())],-1)
printHtmlPart(4)
...
invokeTag('captureBody','sitemesh',22,['class':(pageProperty(name:'body.class')?:'nav-datasets'),'id':(pageProperty(name:'body.id')),'onload':(pageProperty(name:'body.onload'))],2)
printHtmlPart(0)
})
invokeTag('applyLayout','g',22,['name':("main")],1)
}
